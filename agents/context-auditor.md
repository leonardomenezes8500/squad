...
4. **Wrong layer**: code-derivable content (file trees, architecture a reader can see, changelogs), personal preferences in the shared CLAUDE.md, rules for one area of the code sitting in CLAUDE.md instead of a path-scoped `.claude/rules/` file.
